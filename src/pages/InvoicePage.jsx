...
import { DollarSign, FileText, AlertTriangle, Clock, Search, Download, Eye, ChevronDown } from 'lucide-react';
                ...
                <tbody>
                  {filtered.map((inv) => (
                    <tr key={inv.id} className="border-b border-border last:border-0 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-5 py-4 text-right font-semibold">${inv.amount.toLocaleString()}</td>
